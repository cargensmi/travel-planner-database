# Personal Travel Planner Database
...
The Personal Travel Planner database is built to help travelers keep track of:
...
### **SQL Scripts**
- `sql/create_tables.sql` – Contains all `CREATE TABLE` statements, including primary keys, foreign keys, and indexes.
- `sql/insert_data.sql` – Sample database entries for trips, flights, hotels
